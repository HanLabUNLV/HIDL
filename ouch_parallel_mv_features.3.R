...
args <- 'LinkerFastasFeatures/ENSGT00920000149282_0_Linker_9_11.GAAC.tsv' 
...
if((length(tree$tip.label)>10)){
     ...
     setwd("/tmp/") #changed for testing purposes, orig: /data1/home/dbarth/LinkerProject/ModelLengths/
